...
El proyecto original trata sobre el diseño y desarrollo de una placa de adquisición de \acrshort{EEG} haciendo uso de los integrados ADS1299 junto con un sistema de transmisión hacia el ordenador tanto inalámbricamente como a través de USB. La figura \ref{fig:Diseno_base} muestra las partes que componen dicho diseño.
