...
\lstdefinestyle{STM-code}{
  ...
  numberstyle=\color{orange},%\tiny\color{codegray},
  ...
  stepnumber=5,
  tabsize=2,
  morekeywords = {uint8_t, uint16_t, float32_t, SPI_HandleTypeDef},
  literate=
         {á}{{\'a}}1
         {é}{{\'e}}1
         {í}{{\'i}}1
...
\usepackage{multirow}  	% Tablas con elementos que ocupan múltiples filas

\usepackage{yhmath}		% Representación de números periódicos

\usepackage{pdfpages} 	% Permite incluir PDFs